...
{
    internal sealed class PowerParameter<P, Q> : BinaryCompositeQuantitativeParameter<P, Q, BaseUnit>
        where P : BaseUnit, new()
        where Q : BaseUnit, new()
    {
        public PowerParameter(QuantitativeParameterBase<Q> alpha, QuantitativeParameterBase<BaseUnit> beta)
